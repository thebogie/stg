...
impl FlatpickrManager {
    ...
    pub fn init(
        ...
        js_sys::Reflect::set(&options, &JsValue::from_str("enableTime"), &JsValue::from_bool(true))?;
        js_sys::Reflect::set(&options, &JsValue::from_str("time_24hr"), &JsValue::from_bool(true))?;
        js_sys::Reflect::set(&options, &JsValue::from_str("minuteIncrement"), &JsValue::from_f64(5.0))?;
        js_sys::Reflect::set(&options, &JsValue::from_str("dateFormat"), &JsValue::from_str("m/d/Y H:i"))?;
        js_sys::Reflect::set(&options, &JsValue::from_str("allowInput"), &JsValue::from_bool(true))?;
        js_sys::Reflect::set(&options, &JsValue::from_str("clickOpens"), &JsValue::from_bool(true))?;
        ...
        let manager = js_sys::Reflect::get(&web_sys::window().unwrap(), &JsValue::from_str("flatpickrManager"))?;
    ...
    pub fn set_value(&self, element_id: &str, value: &str) -> Result<(), JsValue> {
        ...
        set_value_func.call2(&manager, &JsValue::from_str(element_id), &JsValue::from_str(value))?;
        Ok(())
    }
    ...
    pub fn get_value(&self, element_id: &str) -> Result<String, JsValue> {
        ...
        let result = get_value_func.call2(&manager, &JsValue::from_str(element_id), &JsValue::undefined())?;
    ...
    pub fn destroy(&mut self, element_id: &str) -> Result<(), JsValue> {
        ...
        destroy_func.call2(&manager, &JsValue::from_str(element_id), &JsValue::undefined())?;
...
pub fn fp_init(element_id: &str, initial_value: Option<&str>, on_change: Option<JsValue>) -> Result<(), JsValue> {
    // Create options object
    let options = js_sys::Object::new();
    js_sys::Reflect::set(&options, &JsValue::from_str("enableTime"), &JsValue::from_bool(true))?;
    js_sys::Reflect::set(&options, &JsValue::from_str("time_24hr"), &JsValue::from_bool(true))?;
    ...
    js_sys::Reflect::set(&options, &JsValue::from_str("allowInput"), &JsValue::from_bool(true))?;
    js_sys::Reflect::set(&options, &JsValue::from_str("clickOpens"), &JsValue::from_bool(true))?;
    if let Some(cb) = on_change { js_sys::Reflect::set(&options, &JsValue::from_str("onClose"), &cb)?; }
    ...
    if let Some(value) = initial_value { fp_set_value(element_id, value)?; }
    Ok(())
}
...
pub fn fp_set_value(element_id: &str, value: &str) -> Result<(), JsValue> {
    ...
    let set_value_func = js_sys::Reflect::get(&manager, &JsValue::from_str("setValue"))?;
    let set_value_func: js_sys::Function = set_value_func.into();
    let _ = set_value_func.call2(&manager, &JsValue::from_str(element_id), &JsValue::from_str(value))?;
    Ok(())
}
