...
echo ""
log_info "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
log_info "📋 COPY-PASTE BLOCK - Copy everything below into your production terminal:"
log_info "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
echo -e "${CYAN}# ============================================================================"
echo -e "# Production Deployment Commands"
echo -e "# Copy everything below this line and paste into your production server terminal"
echo -e "# ============================================================================${NC}"
echo ""
echo "# Login to Docker Hub (if not already logged in)"
echo "docker login"
echo ""
echo "# Pull the tested images"
echo "docker pull $FRONTEND_HUB"
echo "docker pull $BACKEND_HUB"
echo ""
echo "# Tag them for deployment"
echo "docker tag $FRONTEND_HUB stg_rd-frontend:latest"
echo "docker tag $BACKEND_HUB stg_rd-backend:latest"
echo ""
echo "# Deploy using the deployment script (assumes you're in repo root on prod server)"
echo "./scripts/deploy-tested-images.sh --version $VERSION_TAG --skip-load"
echo ""
echo "# Or if using deploy.sh from deploy/ directory:"
echo "cd deploy && ./deploy.sh --env production --restart"
echo ""
echo -e "${CYAN}# ============================================================================${NC}"
echo ""
log_info "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
