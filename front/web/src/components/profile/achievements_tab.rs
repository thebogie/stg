...
/// Show when achievements are still loading (same layout as real content, skeleton placeholders).
fn achievements_skeleton() -> Html {
    html! {
        <div class="space-y-6">
            <div class="bg-white rounded-xl shadow-mobile-soft p-6 border border-gray-100">
                <div class="flex items-center justify-between mb-4">
                    <div>
                        ...
                        <div class="h-4 w-72 bg-gray-100 rounded mt-2 animate-pulse" />
                    </div>
                    <div class="h-10 w-10 bg-gray-200 rounded animate-pulse" />
                </div>
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    {for (0..3).map(|_| html! {
                        <div class="rounded-lg p-4 bg-gray-50">
                            <div class="h-3 w-16 bg-gray-200 rounded animate-pulse" />
                            <div class="h-8 w-12 bg-gray-200 rounded mt-2 animate-pulse" />
                        </div>
                    })}
                </div>
            </div>
            <div class="bg-gray-50 rounded-lg p-4">
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    {for (0..3).map(|_| html! {
                        <div>
                            <div class="h-3 w-12 bg-gray-200 rounded animate-pulse mb-2" />
            ...
            <div class="bg-white rounded-xl shadow-mobile-soft p-6 border border-gray-100">
                <div class="h-5 w-32 bg-gray-200 rounded animate-pulse mb-4" />
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {for (0..4).map(|_| html! {
                        <div class="rounded-lg border border-gray-200 p-4 bg-gray-50">
                            <div class="h-4 w-40 bg-gray-200 rounded animate-pulse" />
                            <div class="h-3 w-full bg-gray-100 rounded mt-2 animate-pulse" />
                            <div class="h-2 w-full bg-gray-200 rounded mt-3 animate-pulse" />
                        </div>
                    })}
                </div>
            </div>
