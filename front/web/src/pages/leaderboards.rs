                                ...
                                <table class="min-w-full divide-y divide-gray-200">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        {data.entries.iter().map(|entry| {
                                            ...
                                            let show_id_subtitle = display_name.is_empty()
                                                || display_name == entry.player_id
                                                || display_name.starts_with("Player ");
                                                ...
                                                <tr class="hover:bg-gray-50">
                                                    ...
                                                    <td class="px-3 py-2 text-sm text-gray-900">
                                                        <Link<Route>
                                                            ...
                                                            classes="text-blue-600 hover:text-blue-800 hover:underline font-medium"
                                                        >
                                                            <div class="font-medium">{&display_name}</div>
                                                            if show_id_subtitle {
                                                                <div class="text-xs text-gray-500 font-normal">{entry.player_id.clone()}</div>
                                                            }
                                                        </Link<Route>>
                                                    </td>
